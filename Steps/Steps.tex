...
\section*{\centerline{\Large Steps in the Job Market Process}}\medskip\medskip
...
\item \ifthenelse{\boolean{MyNotes}}{\marginpar{\tiny Ask computer
      ...
      secret from JMPO.}}{}  
  In mid-September, you need to write a short memo about yourself for me and your advisor(s) that includes most of the facts you have entered into the database, as well as crucial extra content.  In this memo, \textit{briefly} describe
...
\section*{\centerline{Employers Lists}}\hypertarget{employers-lists}{}
...
\together{
  \begin{center}
    ...
    \small
     \begin{tabular}{rl}
       Overall- repo & \url{\repourl} \\
       Overall- html & \url{\pageurl}
       % \\ Database      & \url{http://jhuEconPeople.dynalias.org}
       \\ Computer Help      & \JMPHLink
       \\ Cover Letter & \url{\bloburl/Templates/CreateLabelandCoverLetterInstruction.md}
       \\ ASSA meeting & \url{\AEAWeb/conference/}
      \\ \JOE & \url{\AEAWeb/joe/}
      \\ \JOE Signal & \url{\AEAWeb/joe/signal/}
